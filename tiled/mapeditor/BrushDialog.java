...
public class BrushDialog extends JFrame implements ActionListener, ChangeListener, MouseListener, PropertyChangeListener {
		...
		public BrushDialog(MapEditor me, JFrame parent, AbstractBrush currentBrush) {
			super();
			this.parent = parent;
		...
		private JPanel createOptionsPanel() {
			...
			sRandomAmount.setToolTipText("The amount of area to fill with randomness");
