...
public class MapEventAdapter {
	...
	/**
	 * Adds a Component to the list of listeners of map events. Checks that the component is not
	 * already in the list.
	 * @since 0.2.26
	 * @param obj
	 */
	public void addListener(Component obj) {
		 ...
		 * Really only useful to the removeListener() func, as LinkedList.remove()
		 * only removes the first instance of a given object.
		 */
